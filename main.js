...
// const requireFuel = (num) => {
//   let _calcau; 
//   _calcau = num;
//   let requireFuel = Math.floor(_calcau / 3) - 2 > 0 ? Math.floor(_calcau / 3) - 2 : 0;
//   while (_calcau > 0) {
//     return  calcuateFuel(requireFuel) + _calcau;
//   }

// }


// console.log(calcuateFuel(1969))

// console.log(requireFuel((calcuateFuel(1969))));
